...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         $dec_bits[10:0] = {$funct7[5], $funct3 , $op_code};
         ...
         $is_srli = $dec_bits ==? 11'bx_101_0010011;
         $is_srai = $dec_bits ==? 11'bx_101_0010011;
         $is_sub = $dec_bits ==? 11'bx_000_0010011;
         $is_sll = $dec_bits ==? 11'bx_001_0010011;
         $is_slt = $dec_bits ==? 11'bx_010_0010011;
         $is_sltu = $dec_bits ==? 11'bx_011_0010011;
         $is_xor = $dec_bits ==? 11'bx_100_0010011;
         $is_srl = $dec_bits ==? 11'bx_101_0010011;
         $is_sra = $dec_bits ==? 11'bx_101_0010011;
         $is_or = $dec_bits ==? 11'bx_110_0010011;
         $is_and = $dec_bits ==? 11'bx_111_0010011;
         ...
         $is_slti = $dec_bits ==? 11'bx_010_0000011;
      ...
      @3
         ...
         $taken_br = $is_beq ? ($src1_value == $src2_value) :
                     ...
                     $is_bgeu ? ($src1_value >= $src2_value): 1'd0;
